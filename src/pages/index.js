...
const IndexPage = () => {
  ...
  const content = {
    en: {
      ...
      newsletterContent: "This is the newsletter section of the portfolio."
    },
    ro: {
      ...
      newsletterContent: "Aceasta este secțiunea de buletin informativ a portofoliului."
    }
  };
  ...
  return (
    <Layout currentLanguage={language} toggleLanguage={toggleLanguage}>
      ...
      <Section id="newsletter">
        <h1>{content[language].newsletter}</h1>
        <p>{content[language].newsletterContent}</p>
      </Section>
    </Layout>
  );
};
